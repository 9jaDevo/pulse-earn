 ...
 * Countries utility
 * 
 * Provides a comprehensive list of countries for use in dropdowns
 * and ensures uniform country data across the application
 */
...
export const getPopularCountries = (): Country[] => {
  const popularCodes = ['US', 'GB', 'CA', 'AU', 'DE', 'FR', 'JP', 'IN', 'BR', 'MX'];
