/*
  ...
  1. New Tables
    - `payout_requests` - Stores individual payout requests made by ambassadors
    - `payout_methods` - Stores available payout methods and their configurations

  2. Table Modifications
    - `profiles` - Add payout method preferences
    - `ambassadors` - Add total payouts tracking
