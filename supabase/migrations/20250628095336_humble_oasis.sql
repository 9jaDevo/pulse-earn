/*
  # Dynamic Tier-based Commission System

  1. New Tables
    - `ambassador_commission_tiers` - Stores commission tier definitions

  2. Functions
    - Create function to calculate commission rate based on tier
    - Create function to process referral commission
    - Create trigger to update ambassador commission rate when referral count changes
*/
